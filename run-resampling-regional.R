...
path<-"~/Desktop/Yue Cores/Cores_all" # replace with appropriate file path for age model data

# LOAD ECOREGIONS SHAPEFILE__
# Download the Level I Ecoregions of North America Shapefile available at:
# https://www.epa.gov/eco-research/ecoregions-north-america
ecoregions<-readOGR("PaleoVegChange/na_cec_eco_l1/NA_CEC_Eco_Level1.shp") # replace with appropriate file path
